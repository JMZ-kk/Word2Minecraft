...
class OpenAIGenerator(Generator):
    ...
    def create_story(self, story_paragraphs, total_objectives):
        ...
        #                 f"the antagonist somehow. You should describe the environments that those objectives happen"
        #                 f"You can add some NPCs in the story.")
        story_prompt = (f"Write a {story_paragraphs[0]}-{story_paragraphs[1]} paragraph story "
                        f"which has characters including the protagonist trying to achieve something "
                        f"and the antagonist wanting to stop the protagonist. The story should happen"
                        f"in the forest. There should be {total_objectives} "
                        f"objectives for the protagonist in the story. One of them should be to defeat "
                        f"the antagonist somehow. You should describe the environments that those objectives happen"
                        f"You can add some NPCs in the story.")
    ...
    def extract_tileset_info(self, story, story_prompt, character_discriptions, character_prompt):
        ...
        tileset_prompt = ("Create an exhaustive list of tiles needed to create the environment. "
                          "Some tile can occupy more than one space.")
    ...
    def world_generation(self, rounds, previous_story, story_paragraphs, total_objectives, previous_tile_map,
                         ...
                         walkable_tile_discriptions, walkable_tile_prompt, save_dir):
