...
class OpenAIGenerator(Generator):
    ...
    def world_generation(self, rounds, previous_story, story_paragraphs, total_objectives, previous_tile_map,
        ...
        return world_map_fixed, world_map_fixed_with_chars, world_eval_dict, used_char_dict, tile_map_dict, color_tiles_img_with_char, \
            color_tiles_img_with_char, story_paragraphs, objectives, total_objectives, good_feedback_check, bad_feedback_check, no_of_important_tiles
        ...
        try:
            while not except_done:
                ...
                objective_tile_system = ("You are a great planner in 2D game. You plan objectives "
                                         ...
                                         "match the goals extracted from the story. There are 3 objective types: "
                                         "Place-oriented quest(like move from place A to place B), "
                                         "Objective-oriented quest(like get something from the NPC)"
                                         "Time-oriented quest(like Stay at place A for Time duration t "
                                         "or reach A in Time duration t). "
                                         "Each objective should belong to one of 3 types "
                                         "or combinations of 2-3 types."
                ...
                objective_tile_prompt = (f"Given the story:\n{story}\n a 2D tile map of a world was created"
                                         ...
                                         f"position of the tile. The pattearn should be 'Objective': ['tile', row, column]"
